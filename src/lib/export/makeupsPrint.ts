...
.print-logo { width: 28mm; height: 28mm; object-fit: contain; flex-shrink: 0; }
.print-header-text { flex: 1; min-width: 0; }
.page-title { font-size: 22pt; font-weight: 700; margin: 0 0 2mm; }
...
export function buildMakeupsListPrintHtml({
  ...
  const summary = `סה"כ ${rows.length} רשומות`;
